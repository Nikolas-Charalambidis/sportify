        ...
        if (validateForm()) {
            ...
            if (id_match) {
                ...
                const result_host_events = await addEvents(api, id_match, [
                    ...hostState.events, { id_user: null, type: "shot", id_team: hostState.id_team, id_assistance1: null, id_assistance2: null, minute: null, value: hostState.shots, host: 1 }
                ]);
                const result_guest_events = await addEvents(api, id_match, [
                    ...guestState.events, { id_user: null, type: "shot", id_team: guestState.id_team, id_assistance1: null, id_assistance2: null, minute: null, value: guestState.shots, host: 0 }
                ]);

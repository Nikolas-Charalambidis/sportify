                        ...
                        <Form noValidate onSubmit={handleSubmit}>
                                ...
                                <Col xl={12} lg={12}>
                                    <Row>
                                        ...
                                        <Col sm={{ span: 6, offset: 0 }}>
                                            <div className="form-group">
                                                <div className="form-label" style={{ height: '27px', marginBottom: '8px' }}/>
                                                <Button type="submit" variant="secondary" block onClick={() => setShowHomePlayersModal(true)} disabled={isEmpty(homePlayersState.id)}>Soupiska domácích</Button>
                                            </div>
                                        </Col>
                                    ...
                                    <Row>
                                        ...
                                        <Col sm={{ span: 6, offset: 0 }}>
                                            <div className="form-group">
                                                <div className="form-label" style={{ height: '27px', marginBottom: '8px' }}/>
                                                <Button type="submit" variant="secondary" block onClick={() => setShowVisitingPlayersModal(true)} disabled={isEmpty(visitingPlayersState.id)}>Soupiska hostu</Button>
                                            </div>
                                        </Col>
                            ...
                            <Row>
                                <Col className="mb-4 mt-lg-0" lg={{ span: 5, offset: 0 }}>
                                    <Button type="submit" block onClick={() => test()}>Uložit</Button>
                                </Col>
                            </Row>
                            {Number(values.id_team_home) && (
                                <PlayerSelectModal show={showHomePlayersModal} handleClose={handleClose} state={homePlayersState} setter={setHomePlayers}/>
                            )}

                            {Number(values.id_team_visiting) && (
                                <PlayerSelectModal show={showVisitingPlayersModal} handleClose={handleClose} state={visitingPlayersState} setter={setVisitingPlayers} />
                            )}

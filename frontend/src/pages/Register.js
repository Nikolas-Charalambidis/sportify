            ...
            <MainSection>
                ...
                <Form validated={validated}>
                    ...
                    <Form.Group controlId="passwordValidation">
                        <Form.Label>Heslo</Form.Label>
                        <Form.Control isValid={password === passwordValidation} isInvalid={password !== passwordValidation} required type="password" name="passwordValidation" placeholder="Potvrzení hesla" value={passwordValidation} onChange={e => setPasswordValidation(e.target.value)} />
                    </Form.Group>

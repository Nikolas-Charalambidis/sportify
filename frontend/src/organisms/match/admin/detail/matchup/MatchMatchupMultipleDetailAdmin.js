...
export function MatchMatchupMultipleDetailAdmin({id_host, id_guest, id_match, fetchEventsHost, fetchEventsGuest}) {
    const [stateAvailablePlayersHost, fetchAvailablePlayersHost] = useGetAvailableTeamPlayersForMatch(id_host, id_match, "active");
    const [stateAvailablePlayersGuest, fetchAvailablePlayersGuest] = useGetAvailableTeamPlayersForMatch(id_guest, id_match, "active");

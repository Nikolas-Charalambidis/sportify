    ...
    return (
        <div>          
            ...
            <MainSection>
                ...
                <Row>
                    <CardTemplate nazev="Tony Stark" podnazev="Útočník" icon={Icons.faFutbol} sport="fotbal" logo="https://bit.ly/2PCKpYD"
                        bodyAsistence="11/4" trest="6/4" />
                    <CardTemplate nazev="Captain America" podnazev="Útočník" icon={Icons.faFutbol} sport="fotbal" logo="https://bit.ly/320mLrB"
                        bodyAsistence="7/3" trest="0/1" />
                    <CardTemplate nazev="Thor" podnazev="Obránce" icon={Icons.faFutbol} sport="fotbal" logo="https://bit.ly/2WucRx8"
                        bodyAsistence="3/1" trest="0/0" />
                    <CardTemplate nazev="Starlord" podnazev="Obránce" icon={Icons.faHockeyPuck} sport="hokej" logo="https://bit.ly/322b4Rh"
                        bodyAsistence="6/2" trest="1/2" />
                    <CardTemplate nazev="Bruce Banner" podnazev="Brankář" icon={Icons.faFutbol} sport="fotbal" logo="https://bit.ly/2C0BacG"

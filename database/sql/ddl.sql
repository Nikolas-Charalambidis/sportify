...
BEGIN
    ...
    -- calculate shoots
    SELECT SUM(e.value) INTO shoots FROM matchups AS mup
...
DELIMITER //
CREATE TRIGGER TR_EVENTS_AFTER_INSERT AFTER INSERT ON events FOR EACH ROW
BEGIN
...
DELIMITER //
CREATE TRIGGER TR_EVENTS_AFTER_UPDATE AFTER UPDATE ON events FOR EACH ROW
BEGIN
    -- recalculate match goals
    CALL generate_match_goals_data(
            new.id_match, new.id_team, new.type, new.host);
...
DELIMITER //
CREATE TRIGGER TR_EVENTS_AFTER_DELETE AFTER DELETE ON events FOR EACH ROW
BEGIN
    -- recalculate match goals
    CALL generate_match_goals_data(
...
INSERT INTO `competitions` (`id_competition`, `name`, `id_leader`, `id_sport`, `start_date`, `end_date`) VALUES
    (1, 'Hokejová liga 19-20', 1, 1, '2019-09-01 23:59:59', '2020-04-01 23:59:59'),
    (2, 'Florbalová liga', 1, 2, '2017-06-20 23:59:59', '2018-11-20 23:59:59'),
    (3, 'Hokejbalová liga', 1, 3, '2019-09-01 23:59:59', '2020-04-01 23:59:59'),
    (4, 'Hokejová liga 18-19', 1, 1, '2018-09-01 23:59:59', '2019-04-01 23:59:59');
...
INSERT INTO `matches` (id_match, id_competition, id_host, id_guest, date) VALUES
    (1, null, 1, 1, '2018-11-04 16:00:00'),
    (2, null, 1, 1, '2018-11-05 16:00:00'),
    (3, 1, 1, 2, '2018-11-10 16:00:00'),
    (4, 1, 2, 3, '2018-11-11 16:00:00'),
    (5, 1, 3, 1, '2018-11-12 16:00:00');
